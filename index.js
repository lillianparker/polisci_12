...
// No define or require!

// Make sure pipAPI is available (it should be after pi-minno.js loads)
var API = new pipAPI();

// Create your task configuration object
var taskConfig = {
    primeCats: [
        {
            nameForFeedback: "Islamic",
    ...
    base_url: {
        image: "https://lillianparker.github.io/polisci_12/images/" // Or your image URL
    }
};

// Make the task configuration globally accessible
